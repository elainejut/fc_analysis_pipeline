classdef modifiedCircularGraph < handle
% slightly modified from original CircularGraph code
...
% Copyright 2016 The MathWorks, Inc.
  ...
  methods
    function this = modifiedCircularGraph(adjacencyMatrix,varargin)
      % Constructor
      p = inputParser;
      ...
      set(fig,...
        'UserData',this,...
        'CloseRequestFcn',@modifiedCircularGraph.CloseRequestFcn);
